...
const Contact = () => {
  ...
  return (
    <>
      <section className="w-full bg-gradient-to-br from-[#FFD8A8] via-[#FFDAB9] to-[#F8D4DD] ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-start">
