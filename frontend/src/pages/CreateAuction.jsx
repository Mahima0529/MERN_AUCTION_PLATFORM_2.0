...
const CreateAuction = () => {
  ...
  return (
    ...
    // </article>
     ...
     <article className="w-full  w-[100vw] ml-0
    md:w-[100vw] 
    lg:w-[80vw] lg:ml-[20vw] ml-0 m-0 h-fit px-5 pt-10 lg:pl-[100px] flex flex-col">
      <h1
        className={`text-[#111] text-2xl  font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-5xl 2xl:text-4xl`}
     >
        Create Auction
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div class="flex items-center justify-center w-full">
              <label
                for="dropzone-file"
                class="flex flex-col items-center justify-center w-full min-h-[300px] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 p-4"
              >
